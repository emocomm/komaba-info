...
<div class="toolbar">
  ...
  <a id="tool-back-link" class="button-link secondary" href="{{ '/crypto/encrypt/' | relative_url }}">手順ページに戻る</a>
</div>
...
<div class="toolbar">
  ...
  <a class="button-link secondary" href="{{ '/crypto/sign/' | relative_url }}">署名の手順へ進む</a>
</div>
